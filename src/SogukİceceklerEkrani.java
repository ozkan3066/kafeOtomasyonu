...
public class SogukİceceklerEkrani extends JFrame {
    private SiparisYoneticisi siparisYoneticisi;
    private JLabel toplamLabel;

    public SogukİceceklerEkrani() {
    	setResizable(false);
    ...
    private void ekranOlustur() {
        ...
        sicakIceceklerBtn.addActionListener(e -> {
            new SicakİceceklerEkrani().setVisible(true);
            dispose();
        });
        ...
        butonlarPanel.add(sicakIceceklerBtn);
